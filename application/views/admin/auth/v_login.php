      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= base_url('Login/auth') ?>" method="POST">
                    ...
                    <div class="form-footer">
                      <button type="submit" class="btn text-white w-100" style="background-color: #915F6D!important;">Sign in</button>
                    </div>
                  </form>
                </div>
                
                <div class="card-footer">
                  <p class="text-center">Copyright © <?= date('Y') ?> | SaluvWedding</p>
                </div>
              </div>
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="<?= base_url('dist/assets/static/illustration/undraw_secure_login2.svg') ?>" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
